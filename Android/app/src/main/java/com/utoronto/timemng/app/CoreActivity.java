...
/**
 * Core activity for the application. Used sample code from:
...
public class CoreActivity extends Activity {
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		if (checkPlayServices()) {
			...
			CalendarMonthConstructor calendar = CalendarMonthConstructor
					.getInstance(this);
		}
		// TODO: could add some layout actions here
		// Pop up a notification window each time a user opens the application
		// Note this is just a prototype, it will use remote databases in
		// future.
	...
	private SharedPreferences getGCMPreferences(final Context context) {
		...
		return getSharedPreferences(CoreActivity.class.getSimpleName(),
			...
			protected String doInBackground(final Object[] params) {
				...
				try {
					if (null == CoreActivity.this.gcm) {
						CoreActivity.this.gcm = GoogleCloudMessaging
								.getInstance(getApplicationContext());
					}
					CoreActivity.this.regid = CoreActivity.this.gcm
							.register(CoreActivity.this.SENDER_ID);
					msg = "Device registered, registration ID="
							+ CoreActivity.this.regid;
					Log.d(TAG, msg);
					...
					storeRegistrationId(CoreActivity.this.context,
							CoreActivity.this.regid);

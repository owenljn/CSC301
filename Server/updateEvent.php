...
// Execute query
$query = 'Update events '.
      'SET description = "'.$des.'", Location = "'. $loc.'", StartYear = "'. $sy.'", StartMonth = "'. $sm.'", StartDay = "'. $sd.'", StartTime = "'. $st.'", EndYear = "'. $fy.'", EndMonth = "'. $fm.'", EndDay = "'. $fd.'", FinishTime = "'. $ft.'", settings = "'. $settings.'" '.
